...
// spoce no usee my codee, I'm living in your walls
//canvas vars
var canvas;
var ctx;
//sneek vars
...
//this is just a silly little jokster, a silly little guy. dont mess with him.
...
//the programed code made on a chromebook that allows does the math to figure out your heading and make the sneek move in the correct direction at the press of a button, HOW CONVIENT!
function move() {
...
//collison check might be a little bu- feture filled!!!!1!!!1!!
...
//it handles the apple, apples are tasty
...
// does the cylcle of the game drawing and calling all game funcions and also when amogus
function gameCycle() {
...
//keylisteners for the movement code not a key logger
...
//not working win condition I think you would have to be insane to complete this lol
function win(){
  if (dots >= allDots) {
    ctx.fillStyle = 'green';
    ctx.textBaseline = 'middle';
    ...
    ctx.font = "30px Comic Sans MS";
    pauseMusic();
    ctx.fillText('HOW DID YOU BEAT THIS GAME LOL', cWidth/2, cHeight/2);
  }
}
